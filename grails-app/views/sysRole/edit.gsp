...
<html>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <g:hasErrors bean="${sysRoleInstance}">
                <ul class="alert alert-danger" role="alert">
                    <g:eachError bean="${sysRoleInstance}" var="error">
    ...
    <div class="row">
        <g:form url="[resource:sysRoleInstance, action:'update']" method="PUT" class="form-horizontal">
            <g:hiddenField name="version" value="${sysRoleInstance?.version}" />
	...
	%{--	<a href="#edit-sysRole" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-sysRole" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:sysRoleInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${sysRoleInstance?.version}" />
				<fieldset class="form">
					<g:render template="form"/>
				</fieldset>
